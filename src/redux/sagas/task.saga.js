...
function* fetchTaskByCategory(action) {
  try {
    const category = action.payload;
    const response = yield axios.get(`/api/task/byCategory/?q=${category}`);
...
function* taskSaga() {
  ...
  yield takeLatest("FETCH_TASK_BY_CATEGORY", fetchTaskByCategory);
